#coding=utf-8
# test_for_pictures.py	# 验证文件夹下的图像
...
parser.add_argument('--input_dir',type=str,default='/media/pro/PRO/Ubuntu/Common_code/Data_preprocessing/img_012_000000.jpg',help='输入图像位置')
